        ...
        <div className="max-w-[720px] mx-auto">
          ...
          <div className="prose-fh">
            ...
            <blockquote>
              ...
              <cite className="mono tracking-[0.06em] uppercase">— r/Entrepreneur</cite>
            </blockquote>
            ...
            <blockquote>
              ...
              <cite className="mono tracking-[0.06em] uppercase">
            ...
            <blockquote>
              ...
              <cite className="mono tracking-[0.06em] uppercase">— r/startups</cite>
            </blockquote>
