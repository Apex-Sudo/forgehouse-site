      ...
      <article className="px-6 pt-14 md:pt-20 pb-24">
        <div className="max-w-[720px] mx-auto">
          ...
          <div className="prose-fh">
            ...
            <h2>The three structural mistakes</h2>
            ...
            <h2>Personalization that scales</h2>
          ...
          <div className="mt-16 bg-surface border border-border rounded-lg p-8">
            ...
            <h2 className="text-[30px] leading-[1.05]">Get your email torn apart</h2>
            <p className="mt-3 text-[16px] leading-[1.55] text-muted">
              Paste your cold email and get a line-by-line diagnosis plus a rewrite. Free, no login.
            </p>
            <div className="mt-6 max-w-[320px]">
              <ClipButton href="/tools/cold-email-teardown" variant="paper">
                Run the teardown
              </ClipButton>
            </div>
          </div>
