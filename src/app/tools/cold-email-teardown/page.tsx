      ...
      <section className="max-w-[720px] mx-auto px-6 pb-20 space-y-14">
        ...
        <div>
          ...
          <div className="space-y-7">
            <div>
              <h3 className="text-[20px] text-foreground mb-1.5">How long should a cold email be?</h3>
            ...
            <div>
              <h3 className="text-[20px] text-foreground mb-1.5">What makes a good cold email subject line?</h3>
              <p className="text-[16px] leading-[1.6] text-muted">
            ...
            <div>
              <h3 className="text-[20px] text-foreground mb-1.5">Can I paste a LinkedIn message instead?</h3>
              <p className="text-[16px] leading-[1.6] text-muted">
            ...
            <div>
              <h3 className="text-[20px] text-foreground mb-1.5">Is my email stored?</h3>
              <p className="text-[16px] leading-[1.6] text-muted">
        ...
        <div className="border-t border-border pt-8">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-3">
            <Link href="/tools/icp-diagnostic" className="mono text-[12px] tracking-[0.02em] text-muted hover:text-accent transition">
              ICP Diagnostic →
            </Link>
