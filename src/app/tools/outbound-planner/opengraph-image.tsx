...
export const alt = "Outbound Planner — Get a Mon-Fri Sales Action Plan";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Your <span style={{ color: "#3B82F6" }}>outbound plan</span>
          <br />
          for the week. Done.
        </div>
        <div style={{ fontSize: "24px", color: "#737373", lineHeight: 1.5 }}>
          Daily tasks, email templates, and targets. Mon-Fri. Free.
        </div>
      </div>
    ),
    { ...size }
